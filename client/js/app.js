      ...
      function($routeProvider, $compileProvider, $translateProvider, AnalyticsProvider) {
         try {
            ...
            $translateProvider.translations('en_US', {
               ...
               SETTINGS_HTTP_CONTROL_HEADER: 'HTTP control',
               SETTINGS_HTTP_CONTROL_ENABLE: 'Activate HTTP control',
               SETTINGS_HTTP_CONTROL_ENABLE_DESC: 'Besides controlling kettle and motor via GPIOs/relays you can also switch them using smart plugs that can be controlled via HTTP. For this, you only need to provide the URLs to swich the plugs on and off.',
               SETTINGS_HTTP_CONTROL_KETTLE_ON: 'URL kettle on',
               SETTINGS_HTTP_CONTROL_KETTLE_ON_DESC: 'URL to switch on the smart socket that the kettle is plugged into.',
               SETTINGS_HTTP_CONTROL_KETTLE_OFF: 'URL kettle off',
               SETTINGS_HTTP_CONTROL_KETTLE_OFF_DESC: 'URL to switch off the smart socket that the kettle is plugged into.',
               SETTINGS_HTTP_CONTROL_MOTOR_ON: 'URL motor on',
               SETTINGS_HTTP_CONTROL_MOTOR_ON_DESC: 'URL to switch on the smart socket that the motor is plugged into.',
               SETTINGS_HTTP_CONTROL_MOTOR_OFF: 'URL motor off',
               SETTINGS_HTTP_CONTROL_MOTOR_OFF_DESC: 'URL to switch off the smart socket that the motor is plugged into.',
               SETTINGS_HTTP_CONTROL_URL_PLEASE: 'You must provide a URL to control your devices via HTTP',
               ...
               SETTINGS_TELEGRAM_TOKEN_PLEASE: 'Please enter your Telegram bot\'s token.',
               ...
               SETTINGS_TELEGRAM_CHATID_PLEASE: 'Please enter your chat ID.',
               FEEDBACK: 'Feedback',
            ...
            $translateProvider.translations('de_DE', {
               ...
               SETTINGS_HTTP_CONTROL_HEADER: 'HTTP-Steuerung',
               SETTINGS_HTTP_CONTROL_ENABLE: 'HTTP-Steuerung aktivieren',
               SETTINGS_HTTP_CONTROL_ENABLE_DESC: 'Alternativ zum Steuern von Kessel und Motor über GPIOs/Relais kannst du beides auch an smarte Steckdosen anschließen, die per HTTP gesteuert werden können. Dafür benötigst du lediglich die URLs mit denen die Steckdosen ein- und ausgeschaltet werden können.',
               SETTINGS_HTTP_CONTROL_KETTLE_ON: 'URL Kessel an',
               SETTINGS_HTTP_CONTROL_KETTLE_ON_DESC: 'URL, mit der die smarte Steckdose, an der der Kessel angeschlossen ist, eingeschaltet werden kann.',
               SETTINGS_HTTP_CONTROL_KETTLE_OFF: 'URL Kessel aus',
               SETTINGS_HTTP_CONTROL_KETTLE_OFF_DESC: 'URL, mit der die smarte Steckdose, an der der Kessel angeschlossen ist, ausgeschaltet werden kann.',
               SETTINGS_HTTP_CONTROL_MOTOR_ON: 'URL Motor an',
               SETTINGS_HTTP_CONTROL_MOTOR_ON_DESC: 'URL, mit der die smarte Steckdose, an der der Motor angeschlossen ist, eingeschaltet werden kann.',
               SETTINGS_HTTP_CONTROL_MOTOR_OFF: 'URL Motor aus',
               SETTINGS_HTTP_CONTROL_MOTOR_OFF_DESC: 'URL, mit der die smarte Steckdose, an der der Motor angeschlossen ist, ausgeschaltet werden kann.',
               SETTINGS_HTTP_CONTROL_URL_PLEASE: 'Bitte gib die URL zum Steuern des Geräts ein.',
               ...
               SETTINGS_TELEGRAM_TOKEN_PLEASE: 'Bitte gib den Token deines Telegram-Bots ein.',
               SETTINGS_TELEGRAM_CHATID: 'Chat-ID',
               ...
               SETTINGS_TELEGRAM_CHATID_PLEASE: 'Bitte gib deine Chat-ID ein.',
               FEEDBACK: 'Feedback',
